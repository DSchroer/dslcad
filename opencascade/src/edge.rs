...
use opencascade_sys::ffi::{
    ...
    GC_MakeArcOfCircle_point_point_point
};
...
impl Edge {
    pub fn from_points(a: &Point, b: &Point) -> Self {
        ...
        unsafe {
            Edge::Segment(GC_MakeSegment_point_point(&a.point, &b.point))
        }
    }
    ...
    pub fn from_arc(a: &Point, b: &Point, c: &Point) -> Self {
        // SAFETY: cross C++ boundary
        unsafe {
            Edge::Arc(GC_MakeArcOfCircle_point_point_point(&a.point, &b.point, &c.point))
        }
    }
}
